            ...
            <fieldset>
                ...
                <form name="formAutor" method="post" action="AutorServlet">
                    ...
                    <div class="form-group">
                        <label>Codigo :</label>
                        <input type="number" name="codigo" class="form-control" placeholder="000" readonly="readonly" value="<c:out value="${autor.codigo}"/>"> <br/>
                    </div>

                    <div class="form-group">
                        <label>Descrição :</label>
                        <input type="text" name="descricao" class="form-control" required="true"  placeholder="Descrição" value="<c:out value="${autor.descricao}"/>"> <br/>
                    </div>
